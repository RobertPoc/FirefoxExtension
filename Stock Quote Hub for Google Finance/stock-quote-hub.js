/* Quote */
var quote = document.getElementsByClassName('wx62f kno-fb-ctx PZPZlf')[0].textContent; /*document.getElementById('gbqfq').getAttribute('value');*/
quote = quote.slice(quote.indexOf(":") + 1).trim();
/* Data */
